...
list g_lDescriptionsOn = [ /|/showing descriptions for commands when exempted
    ...
    "Wearer may not refuse a teleport offer"  /|/counter-intuitive, but other exceptions stop restrictions from working for subject, while this one adds its own restriction.
];
...
//last_compiled 05/09/2017 08:39:51
//mono
